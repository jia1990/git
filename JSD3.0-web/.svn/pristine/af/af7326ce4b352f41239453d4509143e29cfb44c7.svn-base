define(function(require, exports, module) {
	...
	$("#drawAmount").blur(function(){
		...
		if(drawAmount==""){	
			$(".drawAmountY_spans").html("<font style='color:#FC6210'>请输入提现金额</font>");
		}else if(drawAmount < 100){
			$(".drawAmountY_spans").html("<font style='color:#FC6210'>提现金额必须大于100元</font>");
		}else if(drawAmount>usableMount){
			
			$(".drawAmountY_spans").html("<font style='color:#FC6210'>提现金额不能大于可用余额</font>");
			...
			$.ajax({
		        ...
		        $(".drawAmountY_spans").html("<font style='color:#FC6210'>时间到账金额："+drawAmount+"元,提现手续费为:"+cashFee+"元</font>");
