	...
	var search = function(param,tpl){
		...
		$(".c_date_range li").click(function(){
			...
			if( $(".sInput").val() == undefined){
				var param0 = param + "time="+$(this).data("val") + "&type=" + $("#type li.c_recharge_this").data("val") ;
			}else{
				var param0 = param + "time="+$(this).data("val") + "&type=" + $("#type li.c_recharge_this").data("val") + "&borrowName=" + encodeURIComponent($(".sInput").val()); ;
			}
		...
		$("#type li").click(function(){
			...
			if( $(".sInput").val() == undefined){
				var param0 = param + "type=" + $(this).data("val");
			}else{
				var param0 = param + "type=" + $(this).data("val") +"&borrowName=" + encodeURIComponent($(".sInput").val());
			}
		...
		$("#searchBtn").click(function(){
			...
			{
				var param0 = param + "type=" + $("#type li.c_recharge_this").data("val");
			}else{
				var param0 = param + "type=" + $("#type li.c_recharge_this").data("val") + "&borrowName=" + encodeURIComponent($(".sInput").val());
			}
