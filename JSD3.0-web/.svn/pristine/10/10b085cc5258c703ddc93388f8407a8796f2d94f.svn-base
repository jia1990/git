<div class="y_details_con1">
		<div class="calculatorCpmBox1" style="display: none;">
			...
			<form class="payformcpm" action="/invest/tender.html" name="form1" id="invest_detail_form1" method="post"  onkeydown="if(event.keyCode==13) return false; " >
					...
					<span class="y_spanspay_usable">本次可用钱袋  <em class="mdaClass">0</em> 元</span>
					<input type="checkbox" name="srAccountUse" value="1" id="srAccountUse"/>
					<label for="moneypurses" style="font-size:16px;">可用静态红包</label>
					<span class="y_spanspay_usable">本次可用静态红包  <em class="srPackClass">0</em> 元</span>
					<span>本次可用晋商贷体验卡  <em>{{../realPetCardFreeze}}</em> 元</span>
					<!-- <input type="checkbox" name="ptAccountUse" value="2" id="moneyPetcard"/>
					<span class="y_spanspay_usable">可用体验卡  <em class="petClass">0</em> 元</span>--><br/>
					<label style="font-size:16px;">实际支付</label><span class="y_moneypaycpm"></span><i class="y_mycunit">元</i><br/>
						...
						{{#if ../IsPayPwdNull}}
							...
							<a href="/member/useridentify/identify.html?flag=findpaypwd" style="font-size:12px;color:#005ea7;margin-left:14px;" >忘记密码？</a><br/>
						{{else}}
							...
							<a href="/member/useridentify/identify.html?flag=setpaypwd" style="font-size:12px;color:#005ea7;margin-left:14px;line-height: 60px;" >设置交易密码</a><br/>
						{{/if}}
		...
		<div class="y_details_con1left">
			...
			<div class="y_details_con1leftin" style="width:100%;">
				...
				<h1>
				{{#equal  type "113"}}
					<span style='background: url("{{../../path}}/images/index/bao.png") no-repeat scroll  0 6px transparent;padding-left: 27px;font-size:22px;'>{{name}}</span>
				{{/equal}}
				{{#equal   type "115"}}
					<span style='background: url("{{../../path}}/images/index/bao.png") no-repeat scroll  0 6px transparent;padding-left: 27px;font-size:22px;'>{{name}}</span>
				{{/equal}}
				{{#equal   type "103"}}
					<span style='background: url("{{../../path}}/images/index/ya.png") no-repeat scroll  0 6px transparent;padding-left: 27px;font-size:22px;'>{{name}}</span>
				{{/equal}}
				</h1>
				...
				{{#if borrowPreview}}
			    		{{#inequality borrow/scales 100}}
								<form style="position:relative;margin-left:16px;">
									...
									<input type="hidden" id="tenderToken" name="tenderToken" value="{{../tenderToken}}"/>
									...
									{{#gtpetCard petCardFreeze 0}}
										<div style="color: #555555;font-size: 12px;">&nbsp;&nbsp;&nbsp;&nbsp;晋商贷体验卡(<span>{{petCardFreeze}}</span>元) </div>
									{{/gtpetCard}}
		...
		<div class="y_details_con2left">
			...
			<!-- // JSDP-206  wcw 2015-07-02 start -->
				{{#with borrow}}
					...
					<li style="width:173px;" class="riskguarantee">
					<span style="width:173px;">风险控制</span>
				</li>
				<li style="width:174px;" class="tenderlist">
					<span style="width:174px;">投资列表</span>
				</li>
				<li style="width:174px;" class="repaylist">
			...
			<div class="y_projectDetails y_detailscon2leftcon" style="display:block;">
				...
				{{#with borrow}}
				<p class="y_h3_color" style="word-wrap:break-word;word-break:normal;">{{{content}}}</p>
				{{/with}}
				</div>
			</div>
			...
			<div class="y_InvestmentDetails y_detailscon2leftcon">
				...
				<ul class="y_details_con2rightscrollt">
					<li style="padding:0;">
						<dl>
						    <dd style="width:30px;padding:0;">序号</dd>
				...
				<div id="tenderkkpager" style="margin-right:20px;" ></div>
			</div>
			<!-- 还款计划 -->
			<div class="y_InvestmentDetails y_detailscon2leftcon">
				<h2>还款计划</h2>
				...
				<div id="repaymentkkpager" class="kkpager" style="text-align:right;margin-top:20px;margin-right:22px;"></div>
			</div>
		</div>
