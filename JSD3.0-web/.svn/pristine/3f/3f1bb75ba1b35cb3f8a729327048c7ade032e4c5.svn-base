		...
		<#if topic.read>
			<#if topic.status == STATUS_UNLOCKED>
				<#if topic.type == TOPIC_ANNOUNCE>
					<img class="icon_folder_announce" src="${contextPath}/bbs/images/transp.gif" alt="" />
				<#elseif topic.type == TOPIC_STICKY>
					<img class="icon_folder_sticky" src="${contextPath}/bbs/images/transp.gif" alt="" />
				<#else>
					<#if topic.isHot()>
						<img class="icon_folder_hot" src="${contextPath}/bbs/images/transp.gif" alt="" />
					<#else>
						<img class="icon_folder" src="${contextPath}/bbs/images/transp.gif" alt="" />
					</#if>
				</#if>
			<#else>
				<img class="icon_folder_lock" src="${contextPath}/bbs/images/transp.gif" alt="" />
			</#if>
		<#else>
			<#if topic.status == STATUS_UNLOCKED>
				<#if topic.type == TOPIC_ANNOUNCE>
					<img class="icon_folder_announce_new" src="${contextPath}/bbs/images/transp.gif" alt="" />
				<#elseif topic.type == TOPIC_STICKY>
					<img class="icon_folder_sticky_new" src="${contextPath}/bbs/images/transp.gif" alt="" />
				<#else>
					<#if topic.isHot()>
						<img class="icon_folder_new_hot" src="${contextPath}/bbs/images/transp.gif" alt="" />
					<#else>
						<img class="icon_folder_new" src="${contextPath}/bbs/images/transp.gif" alt="" />
					</#if>
				</#if>
			<#else>
				<img class="icon_folder_lock_new" src="${contextPath}/bbs/images/transp.gif" alt="" />
			</#if>
		</#if>
	<#else>
		<img class="icon_topic_move" src="${contextPath}/bbs/images/transp.gif" alt="" />
	</#if>
</#macro>
			...
			<#list poll.options as option>
				<tr>
					...
					<td nowrap="nowrap" width="210">
						<img class="icon_vote_lcap" src="${contextPath}/bbs/images/transp.gif" alt="" /><img 
							src="${contextPath}/bbs/templates/${templateName}/images/voting_bar.gif" width="${option.votePercentage * 2}" height="12" alt="" /><img 
							class="icon_vote_rcap" src="${contextPath}/bbs/images/transp.gif" alt="" />
					</td>
