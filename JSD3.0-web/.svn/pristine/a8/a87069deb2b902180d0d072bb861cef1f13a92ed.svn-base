define(function(require,exports,module){
	var showTableInvest = require('./showTableInvest');
	var search = function(param,tpl){
		...
		$(".c_date_range li").click(function(){
			...
			if( $(".sInput").val() == undefined){
				var param0 = param + "time="+$(this).data("val") + "&drawHandleStatus=" + $("#drawHandleStatus li.c_recharge_this").data("val") ;
			}else{
				var param0 = param + "time="+$(this).data("val") + "&drawHandleStatus=" + $("#drawHandleStatus li.c_recharge_this").data("val") + "&borrowName=" + encodeURIComponent($(".sInput").val()); ;
			}
			showTableInvest.ajaxUrl(param0,tpl);
		});

		//交易状态
		$("#drawHandleStatus li").click(function(){
			$(this).addClass("c_recharge_this").siblings().removeClass("c_recharge_this");
		
			if( $(".sInput").val() == undefined){
				var param0 = param + "drawHandleStatus=" + $(this).data("val");
			}else{
				var param0 = param + "drawHandleStatus=" + $(this).data("val") +"&borrowName=" + encodeURIComponent($(".sInput").val());
			}	
		...
		$("#searchBtn").click(function(){
			...
			{
				var param0 = param + "drawHandleStatus=" + $("#drawHandleStatus li.c_recharge_this").data("val");
			}else{
				var param0 = param + "drawHandleStatus=" + $("#drawHandleStatus li.c_recharge_this").data("val") + "&borrowName=" + encodeURIComponent($(".sInput").val());
			}
