	...
	$.ajax({
		...
		success:function(json){
			require.async('/plugins/handlebars-v1.3.0/handlebars-v1.3.0',function(){
				...
				$(".y_account_right_top").html(Handlebars.compile(require("../../tpl/member_borrow/accset.tpl"))(json));
			  });
            });
			/*826   fgq  3.18   安全等级*/
	...
	$.ajax({
		...
		success:function(json){
			require.async('/plugins/handlebars-v1.3.0/handlebars-v1.3.0',function(){
	            require.async('/plugins/handlebars-v1.3.0/transFormatJson',function(){
	            //  找回  交易密码内容
				$(".c_find_detail").html(Handlebars.compile(require("../../tpl/member_borrow/accsetFindPayPwd.tpl"))(json));
				//找回密码方式切换
		...
		success:function(json){
			require.async('/plugins/handlebars-v1.3.0/handlebars-v1.3.0',function(){
	            require.async('/plugins/handlebars-v1.3.0/transFormatJson',function(){
	            	...
	            	$(".updateQuestion").html(Handlebars.compile(require("../../tpl/member_borrow/accsetQuestion.tpl"))(json));
	            	isOver++;
		...
		success:function(data){
			...
			require.async('/plugins/handlebars-v1.3.0/handlebars-v1.3.0',function(){
	            require.async('/plugins/handlebars-v1.3.0/transFormatJson',function(){
	            	...
	            	$(".c_update_login_pwd").html(Handlebars.compile(require("../../tpl/member_borrow/updateLoginPwd.tpl"))(data));
	            	$(".c_update_way").html(Handlebars.compile(require("../../tpl/member_borrow/updatePhone.tpl"))(data));
	            	$(".c_update_way2").html(Handlebars.compile(require("../../tpl/member_borrow/updateEmail.tpl"))(data));
	            						...
	            						success:function(json){
	            							...
	            							if(!json.result){
	            								...
	            								$("#checkPhoneCodeSubmit").click(function(){
		            								$.ajax({
		            									type:"post",
		            									url:"/member_borrow/account/sendMobileMsgUM.html?flag="+newEMPSmsFlag,
		            									dataType:"json",
