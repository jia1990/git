define(function(require,exports,module){
	var showTableInvest = require('./cardTransferLogShowTable');
	var search = function(param,tpl){
		...
		$(".c_date_range li").click(function(){
			...
			var param0 = param + "time=" + $(this).data("val") + "&receiveStatus=" + $("#c_transType_status li.c_recharge_this").data("val") ;
			showTableInvest.ajaxUrl(param0,tpl);
		});

		//交易状态(结果)
		$("#c_transType_status li").click(function(){
			$(this).addClass("c_recharge_this").siblings().removeClass("c_recharge_this");
		
			var param0 = param + "receiveStatus=" + $(this).data("val");
		...
		$("#searchBtn").click(function(){
			...
			var param0 = param + "receiveStatus=" + $("#c_transType_status li.c_recharge_this").data("val");
