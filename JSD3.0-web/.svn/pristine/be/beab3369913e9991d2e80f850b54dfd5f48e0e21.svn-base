...
var tenderkkpager = {
			...
			hrefFormer			: '', //链接前部
			hrefLatter			: '', //链接尾部
			gopageWrapId		: 'tenderkkpager_gopage_wrap',
			gopageButtonId		: 'tenderkkpager_btn_go',
			gopageTextboxId		: 'tenderkkpager_btn_go_input',
			lang				: {
			firstPageText			: '首页',
			firstPageTipText		: '首页',
			lastPageText			: '尾页',
		...
		generPageHtml : function(config,enforceInit){
			...
			if(this.isGoPage){
				gopage_info = '&nbsp;'+this.lang.gopageBeforeText+'<span id="'+this.gopageWrapId+'">'+
					'<input type="button" id="'+this.gopageButtonId+'" onclick="tenderkkpager.gopage()" value="'
						+this.lang.gopageButtonOkText+'" />'+
					'<input type="text" id="'+this.gopageTextboxId+'" onfocus="tenderkkpager.focus_gopage()"  onkeypress="return tenderkkpager.keypress_gopage(event);"   onblur="tenderkkpager.blur_gopage()" value="'+this.next+'" /></span>'+this.lang.gopageAfterText;
			}
		...
		_getHandlerStr : function(n){
			if(this.mode == 'click'){
				return 'href="'+this.getHref(n)+'" onclick="return tenderkkpager._clickHandler('+n+')"';
			}
			//link模式，也是默认的
