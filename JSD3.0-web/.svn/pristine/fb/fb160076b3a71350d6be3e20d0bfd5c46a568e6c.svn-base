    ...
    success:function(json){
      ...
      require.async("/plugins/handlebars-v1.3.0/handlebars-v1.3.0",function(){
          require.async("/plugins/handlebars-v1.3.0/transFormatJson",function(){
            $("#invest-main-box").html(Handlebars.compile(require("../../tpl/invest/stagesDetail.tpl"))(json));
        	...
        	$(".y_detailsinputs").change(function(){
        		//if (parseInt($(".y_detailsinputs").val())>mostAccount) {
	        		$.ajax({
	    				type:"get",
	    				url:"/invest/getInv.html?money="+$(".y_detailsinputs").val()+"&id="+$("#bid_id").val(),
													...
													require.async('jquery.form',function(){
									    				$("#invest_detail_form1").ajaxSubmit(function(data){
									    					if(data.result==null){
									    						...
									    						//$.alert("投标失败，请联系客服。","提示",function(){window.location.reload();},true);
									    						alertNew("投标失败，请联系客服。","提示",function(){window.location.reload();},true);
									    					}else{
										    					if(data.result){
									    							$(".calculatorCpmBox1").hide();
									    							$(".calculatorCpmBottom").hide();
										    						...
										    						//$.alert(data.msg,"提示",function(){window.location.reload();},true);
