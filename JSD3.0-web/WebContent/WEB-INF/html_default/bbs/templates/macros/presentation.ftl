		...
		<#if topic.read>
			<#if topic.status == STATUS_UNLOCKED>
				<#if topic.type == TOPIC_ANNOUNCE>
					<img class="icon_folder_announce" src="${contextPath}/themes/bbs/images/transp.gif" alt="" />
				<#elseif topic.type == TOPIC_STICKY>
					<img class="icon_folder_sticky" src="${contextPath}/themes/bbs/images/transp.gif" alt="" />
				<#else>
					<#if topic.isHot()>
						<img class="icon_folder_hot" src="${contextPath}/themes/bbs/images/transp.gif" alt="" />
					<#else>
						<img class="icon_folder" src="${contextPath}/themes/bbs/images/transp.gif" alt="" />
					</#if>
				</#if>
			<#else>
				<img class="icon_folder_lock" src="${contextPath}/themes/bbs/images/transp.gif" alt="" />
			</#if>
		<#else>
			<#if topic.status == STATUS_UNLOCKED>
				<#if topic.type == TOPIC_ANNOUNCE>
					<img class="icon_folder_announce_new" src="${contextPath}/themes/bbs/images/transp.gif" alt="" />
				<#elseif topic.type == TOPIC_STICKY>
					<img class="icon_folder_sticky_new" src="${contextPath}/themes/bbs/images/transp.gif" alt="" />
				<#else>
					<#if topic.isHot()>
						<img class="icon_folder_new_hot" src="${contextPath}/themes/bbs/images/transp.gif" alt="" />
					<#else>
						<img class="icon_folder_new" src="${contextPath}/themes/bbs/images/transp.gif" alt="" />
					</#if>
				</#if>
			<#else>
				<img class="icon_folder_lock_new" src="${contextPath}/themes/bbs/images/transp.gif" alt="" />
			</#if>
		</#if>
	<#else>
		<img class="icon_topic_move" src="${contextPath}/themes/bbs/images/transp.gif" alt="" />
	</#if>
</#macro>
			...
			<#list poll.options as option>
				<tr>
					...
					<td nowrap="nowrap" width="210">
						<img class="icon_vote_lcap" src="${contextPath}/themes/bbs/images/transp.gif" alt="" /><img 
							src="${contextPath}/bbs/templates/${templateName}/images/voting_bar.gif" width="${option.votePercentage * 2}" height="12" alt="" /><img 
							class="icon_vote_rcap" src="${contextPath}/themes/bbs/images/transp.gif" alt="" />
					</td>
...
<#macro moderationImages>
	...
	<#if isModerator || isAdmin>
		<#if can_remove_posts?default(false)>
			<a href="javascript:deleteTopic();"><img class="icon_topic_delete" src="${contextPath}/bbs/images/transp.gif" title="${I18n.getMessage("Delete")}" alt="" /></a>
		</#if>
		
		<#if can_move_topics?default(false)>
			<a href="javascript:moveTopic();"><img class="icon_topic_move" src="${contextPath}/bbs/images/transp.gif" title="${I18n.getMessage("move")}" alt="" /></a>
		</#if>

		<#if can_lockUnlock_topics?default(false)>			
			<#if topic.status == STATUS_LOCKED>
				<a href="javascript:lockUnlock(false);"><img class="icon_topic_unlock" src="${contextPath}/bbs/images/transp.gif" title="${I18n.getMessage("Unlock")}" alt="" /></a>
			<#else>
				<a href="javascript:lockUnlock(true);"><img class="icon_topic_lock" src="${contextPath}/bbs/images/transp.gif" title="${I18n.getMessage("Lock")}" alt="" /></a>
			</#if>
		</#if>
	</#if>
</#macro>
