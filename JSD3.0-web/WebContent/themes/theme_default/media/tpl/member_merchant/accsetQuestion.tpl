...
<div class="c_mobile_valid">
	...
	<form action="/member_borrow/account/setNewQuestion.html" method="post" id="setform">
		...
		<dd><label style="display:inline-block;width:84px;text-align:right;">回答</label><input type="text" name="answer1" class="c_qa" onkeyup="this.value=this.value.replace(/^ +| +$/g,'')"/><span class="c_qa_msg" style="width:294px;"></span></dd>
...
<div class="c_mobile_valid" style="display:none;">
	...
	<div class="c_pwd_success">密保设置成功<a href="/member_borrow/account/asetpre.html">返回账户设置</a></div>
</div> 
{{else}}
<!-- 第一步 -->
<div class="c_mobile_valid">
...
<div class="c_mobile_valid" style="display:none;">
	...
	<div class="c_pwd_success">密保修改成功<a href="/member_borrow/account/asetpre.html">返回账户设置</a></div>
</div> 
{{/equal}}
