...
{{#if data.list}}
	{{#each data.list}}
		<li>
			<dl>
				...
				<dd style="width:150px;">{{logBorrowNameFun name}}</dd>
	...
	{{/each}}
	<a id="borrowmore" hidefocus class="c_refund_info" href="/member_guarantee/guarantee/projectManage.html">查看更多担保项目&gt;&gt;</a>
{{else}}
