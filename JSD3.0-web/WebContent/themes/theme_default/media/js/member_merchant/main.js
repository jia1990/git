...
define(function(require,exports,module){
        ...
        success:function(json){
        	require.async("/plugins/handlebars-v1.3.0/handlebars-v1.3.0",function(){
                require.async('/plugins/handlebars-v1.3.0/transFormatJson',function(){
                	$(".MemberCenter_con1in").append(Handlebars.compile(require("../../tpl/member_merchant/main_info.tpl"))(json));
                	 $(function(){
    ...
    $.ajax({
        type:"post",
        url:"/member_merchant/merchantDetailList.html",
        dataType:"json",
        success:function(json){
            require.async("/plugins/handlebars-v1.3.0/handlebars-v1.3.0",function(){
                require.async('/plugins/handlebars-v1.3.0/transFormatJson',function(){
                	$(".memberData").html(Handlebars.compile(require("../../tpl/member_merchant/main_merchant_account.tpl"))(json));
                	   // 更换客服
    ...
    // 已完成订单详情
    $.ajax({
  		url:'/member_merchant/orderFinishDetailList.html',
  		type:'get',
  		dataType:'json',
  		success:function(json){
  			require.async('/plugins/handlebars-v1.3.0/handlebars-v1.3.0',function(){
  	            require.async('/plugins/handlebars-v1.3.0/transFormatJson',function(){
  	            	//$($(".record_conssin_num")[0]).html(Handlebars.compile(require('../../tpl/member_merchant/main_order.tpl'))(json));
  	            	if(!json.data.length){
    ...
    $(".c_record li:eq(1)").one("click",function(){
         $.ajax({
            url:'/member_merchant/cashList.html',
            type:'get',
            dataType:'json',
            success:function(json){
          	  require.async('/plugins/handlebars-v1.3.0/handlebars-v1.3.0',function(){
                    require.async('/plugins/handlebars-v1.3.0/transFormatJson',function(){
                    	if(json.data.list.length>0){
                    		$($(".record_conssin_num")[1]).html(Handlebars.compile(require('../../tpl/member_merchant/main_cash.tpl'))(json));
                    	}else{
                    	...
                    	if(json.data.list.length>=5){
                    		$(".c_draw_log").hide();
                    		$(".c_draw_log").eq(0).show();
                    		$(".c_draw_log").eq(1).show();
                    		$(".c_draw_log").eq(2).show();
                    		$(".c_draw_log").eq(3).show();
                    	}
                    	/*
                        if(!json.data.length){
                     		 //$("#repaymentmore").hide();
    ...
    // 完成订单记录
	/*$.ajax({
        url:'/member_guarantee/borrow/storeIndentDetailList.html',
        type:'get',
        dataType:'json',
        success:function(json){
        	if(json.data.list.length){
        		require.async('/plugins/handlebars-v1.3.0/handlebars-v1.3.0',function(){
                    require.async('/plugins/handlebars-v1.3.0/transFormatJson',function(){
                        $(".main_order").html(Handlebars.compile(require('../../tpl/member_merchant/main_order.tpl'))(json));
                    });
                });
        	}else{
