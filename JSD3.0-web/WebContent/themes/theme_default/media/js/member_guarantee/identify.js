define(function(require,exports,module){
	...
	$.ajax({
		...
		success:function(json){
			require.async('/plugins/handlebars-v1.3.0/handlebars-v1.3.0',function(){
				...
				$(".y_account_right_top").html(Handlebars.compile(require("../../tpl/member_guarantee/accset.tpl"))(json));
			  });
            });
			/*826   fgq  3.18   安全等级*/
	...
	$.ajax({
		...
		success:function(json){
			require.async('/plugins/handlebars-v1.3.0/handlebars-v1.3.0',function(){
	            require.async('/plugins/handlebars-v1.3.0/transFormatJson',function(){      	
	            //  找回  交易密码内容
				$(".c_find_detail").html(Handlebars.compile(require("../../tpl/member_guarantee/accsetFindPayPwd.tpl"))(json));
				//找回密码方式切换
		...
		success:function(json){
			require.async('/plugins/handlebars-v1.3.0/handlebars-v1.3.0',function(){
	            require.async('/plugins/handlebars-v1.3.0/transFormatJson',function(){
	            	...
	            	$(".updateQuestion").html(Handlebars.compile(require("../../tpl/member_guarantee/accsetQuestion.tpl"))(json));
	            	isOver++;
	...
	$.ajax({
		...
		success:function(json){
			require.async('/plugins/handlebars-v1.3.0/handlebars-v1.3.0',function(){
	            require.async('/plugins/handlebars-v1.3.0/transFormatJson',function(){
				$(".c_update_detail1").html(Handlebars.compile(require("../../tpl/member_guarantee/accsetPaypwd.tpl"))(json));
				if(json.result){ // 设置
				...
				if($("#sflag").val()=="setpaypwd"){
					//设置交易密码之前判断是否设置了密保问题
							$.ajax({
								...
								success:function(json){
									if(!json.size>0){
										$.alert("为了您的账户安全，设置交易密码前先设置密保问题","提示",function(){},true);
						...
						$.ajax({
							...
							success:function(json){
								if(!json.size>0){
									...
									$.alert("为了您账户的安全，请先设置密保问题","提示",function(){},true);
									$(".paypwdSet").parent().next('.c_update_detail').slideUp(500);
									/*$(".myquestion").click();
									$(".myquestion").parent().parent().find('.c_update_detail').slideDown(500);*/
									$('.y_account_div_a').eq(2).click();
		...
		success:function(data){
			...
			require.async('/plugins/handlebars-v1.3.0/handlebars-v1.3.0',function(){
	            require.async('/plugins/handlebars-v1.3.0/transFormatJson',function(){
	            	...
	            	$(".c_update_login_pwd").html(Handlebars.compile(require("../../tpl/member_guarantee/updateLoginPwd.tpl"))(data));
	            	$(".c_update_way").html(Handlebars.compile(require("../../tpl/member_guarantee/updatePhone.tpl"))(data));
	            	$(".c_update_way2").html(Handlebars.compile(require("../../tpl/member_guarantee/updateEmail.tpl"))(data));
	            						...
	            						if(!json.result){
	            							...
	            							if (uEvalidNewEmailCode2) {
	            								...
	            								$("#checkPhoneCodeSubmit").click(function(){
	            									$.ajax({
	            										type:"post",
	            										url:"/member_borrow/account/sendEmailMsgNA.html?email="+email,
	            										data : {flag:upesmsflag,validCode:$("#sendSmsValidCode").val()},
	            										dataType:"json",
	            										success:function(json){
	            										if(!json.result){
